            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-800 rounded-lg p-4 flex items-center justify-between">
                  <div>
                    <p className="text-white font-semibold">Save Search History</p>
                    <p className="text-slate-400 text-sm">Remember your searches</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-5 h-5 rounded" />
                </div>
                <button
                  className="w-full bg-red-600/20 hover:bg-red-600/30 text-red-400 px-4 py-2 rounded-lg transition border border-red-600/50 font-semibold mt-4"
                >
